...
/**
 * This annotation is used to indicate that a field or property references a composite object (an object that is
 * *dependent* -- meaning that it has no second purpose -- on the referring field's class). By default, the
 * composite relation arrow is included in all diagrams without a label. A label can be added with [label] and
 * the type and cardinality of the referent can be specified with [referent] and [referentCardinality]. If omitted,
...
annotation class UmlComposition
(
    /**
