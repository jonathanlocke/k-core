...
open class Information : OperationStatusMessage
{
    constructor(message: String?, vararg arguments: Any?) : this(null, message, *arguments)
    constructor(cause: Throwable?, message: String?, vararg arguments: Any?) : super(DO_NOT_FORMAT_CAUSE, cause, message, arguments)
    constructor()
